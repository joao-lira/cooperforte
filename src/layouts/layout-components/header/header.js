          ...
          <div
            ...
            <NavbarBrand href="/">
              ...
              <span className="logo-text">
                <span className="dark-logo text-dark">Cooperforte</span>
                <span className="light-logo">Cooperforte</span>
                {/*
            ...
            <Nav className="ml-auto float-right" navbar>
              ...
              <UncontrolledDropdown nav inNavbar>
                <DropdownToggle nav caret className="pro-pic">
                  <img
                    src={this.props.auth.user.user_avatar}
                    alt="user"
                    className="rounded-circle"
                    width="31"
                  />
                ...
                <DropdownMenu right className="user-dd">
                  <div className="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                    ...
                    <div className="ml-3">
                      <h4 className="mb-0">
                        {this.props.auth.user.user_username}
                      </h4>
